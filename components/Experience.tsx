...
const experiences = [
  {
    ...
    date: "Present",
    description:
      "Doing literally everything: frontend, backend, Docker, pipelines, and probably making coffee.",
  },
  {
    role: "DevOps Intern",
  ...
  },
  {
    ...
    date: "2023 - Present",
    description:
      "Building websites and products for clients who definitely know what they want.",
  },
];
        ...
        <div className="flex flex-col flex-grow relative mt-12">
          ...
          {experiences.map((exp, i) => (
            ...
            >
              ...
              <h3 className="text-3xl font-display font-bold text-zinc-100 group-hover/item:text-rose-400 transition-colors mb-2">
                {exp.role}
              </h3>
              <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-6 text-sm font-medium mb-4">
                <div className="flex items-center gap-2 text-rose-500">
                  {exp.logo && (
                    <img
                      src={exp.logo}
                      alt={exp.company}
                      className="w-5 h-5 rounded-full object-cover grayscale opacity-70 group-hover/item:grayscale-0 group-hover/item:opacity-100 transition-all"
                    />
                  )}
                  {exp.link ? (
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="uppercase tracking-widest hover:underline hover:text-rose-400 transition-colors"
                    >
                      {exp.company} ↗
                    </a>
                  ) : (
                ...
                <span className="text-zinc-600 font-mono tracking-wider text-xs">
                  {exp.date}
                </span>
              </div>
