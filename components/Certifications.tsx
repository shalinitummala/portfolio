...
const certs = [
  {
    title: "Indian Institute of Internship",
    status: "Internship Completed",
    id: "III-001X",
    date: "2023",
    image: "/project-logos/Internship-certificate-III.webp",
  },
  {
    ...
    id: "DCK-8091",
    date: "2024",
    image: "/docker-certificate.webp",
  },
  {
    title: "Linux Fundamentals",
    status: "Knows how to exit Vim",
    id: "LNX-0042",
    date: "2023",
    image: "/project-logos/linux-certificate.webp",
  },
  {
    title: "Python for Beginners",
    status: "Can print 'Hello'",
    id: "PY-1337",
    date: "2023",
    image: "/project-logos/python-certificate.webp",
  },
  {
    title: "NITI Aayog DevOps",
    status: "Gov Approved",
    id: "GOV-001X",
    date: "2024",
    image: "/project-logos/niti-certificate.webp",
  },
];
        ...
        <div className="mb-16 border-b border-zinc-800 pb-8 flex flex-col md:flex-row md:items-end justify-between gap-4">
          <div>
            <h2 className="text-5xl md:text-6xl font-display font-bold text-zinc-100 tracking-tighter">
              Fancy{" "}
              <span className="text-rose-500 italic font-serif">Papers</span>
            </h2>
          ...
          {certs.map((cert, i) => (
            <motion.a
              ...
              className={`relative flex bg-[#0c0c0e] rounded-xl overflow-hidden group shadow-2xl ${
                cert.image
                  ? "cursor-pointer hover:-translate-y-2 transition-transform duration-300"
                  : "cursor-default"
              }`}
            >
                ...
                <div className="relative z-10 flex flex-col h-full justify-between gap-6">
                  ...
                  <div className="flex justify-between items-end border-t border-zinc-800/50 pt-4 mt-4">
                    <div>
                      ...
                      <p className="text-rose-400 font-mono text-sm font-bold uppercase tracking-wider">
                        {cert.status}
                      </p>
                    </div>
