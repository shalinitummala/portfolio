    ...
    >
      <div className="h-10 w-full bg-zinc-900/80 flex items-center justify-between px-4 cursor-grab active:cursor-grabbing border-b border-zinc-800/50">
        <div className="flex items-center gap-2">
          ...
          <span className="text-[10px] font-mono font-medium text-zinc-500 ml-2 uppercase tracking-widest">
            Antigravity PiP
          </span>
        </div>
        <button
      ...
      <div
        className="relative flex-1 bg-black w-full h-full cursor-pointer"
        onClick={togglePlay}
      >
        <iframe
          ref={iframeRef}
